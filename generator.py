    ...
    def main(self):  # The main function contains the most important code
        ...
        if os.name == "nt":  # If the system is windows
            ...
            ctypes.windll.kernel32.SetConsoleTitleW(
                "Nitro Generator and Checker - Made by ErenPRO#2414")  # Change the
        else:  # Or if it is unix
            print(f'\33]0;Nitro Generator and Checker - Made by ErenPRO#2414\a',
...
| |     / _ \\ \ / // _ \| '__|| |     |  __|    \   /  
| |____| (_) |\ V /|  __/| |   | |____ | |____    | |   
 \_____|\___/  \_/  \___||_|   |______||______|   |_|   
                                                            
""")  # Print the title card
        time.sleep(2)  # Wait a few seconds
        # Print who developed the code
        self.slowType("Made by: ErenPRO#2414 && CoverLEY#0279", .02)
        """print("Help:https://discord.gg/E4QuVaRR4x")"""
        ...
        for s in c:  # Loop over the amount of codes to check
            ...
            if os.name == "nt":  # If the system is windows
                ctypes.windll.kernel32.SetConsoleTitleW(
                    f"Nitro Generator and Checker - {len(valid)} Valid | {invalid} Invalid - Made by ErenPRO#2414")  # Change the title
                print("")
            else:  # If it is a unix system
                # Change the title
                print(
                    f'\33]0;Nitro Generator and Checker - {len(valid)} Valid | {invalid} Invalid - Made by ErenPRO#2414\a', end='', flush=True)
